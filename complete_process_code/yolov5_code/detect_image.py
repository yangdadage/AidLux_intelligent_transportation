...
@torch.no_grad()
def run(
        weights=ROOT / '/models/best.pt',  # model.pt path(s)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'models/yolov5_car_best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / 'data/images/tests', help='file/dir/URL/glob, 0 for webcam')
