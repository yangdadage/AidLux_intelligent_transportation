...
class Detect_Model(nn.Module):
    def __init__(self, num_classes=2):
        ...
        pth_path = os.path.join("D:/python_project/jiang_dabai/intelligent_transportation/Lesson5_code/model/",
                                'track2_resnet50_ANT_best_albation1_64_checkpoint.pth')
...
### 对抗攻击监测
folder = 'D:/python_project/jiang_dabai/intelligent_transportation/Lesson5_code/adv_code/orig_images/'
img_name_lst = os.listdir(folder)
img_name_lst = [p for p in img_name_lst if p.endswith('jpg') or p.endswith('png')]
for img_name in img_name_lst:
    print(img_name)
    np_img = get_image(folder + img_name)
